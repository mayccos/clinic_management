...
class Patient(models.Model):
    ...
    first_visit_date = models.DateField(null=True, blank=True, editable=False)  # Non modifiable dans l'admin
...
class TreatmentAdmin(admin.ModelAdmin):
    list_display = ('patient', 'disease', 'medical_treatment', 'treatment_date',)
